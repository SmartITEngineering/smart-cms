 ...
 */
@Singleton
public class RepresentationSchemaBaseConfigProvider implements
    Provider<SchemaInfoProviderBaseConfig<PersistentRepresentation>> {

  @Override
  public SchemaInfoProviderBaseConfig<PersistentRepresentation> get() {
    try {
      final InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream(
          "com/smartitengineering/cms/spi/impl/content/RepresentationSchemaBaseConfig.json");
