 ...
 */
@Singleton
public class VariationSchemaBaseConfigProvider implements
    Provider<SchemaInfoProviderBaseConfig<PersistentVariation>> {

  @Override
  public SchemaInfoProviderBaseConfig<PersistentVariation> get() {
    try {
      final InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream(
          "com/smartitengineering/cms/spi/impl/content/VariationSchemaBaseConfig.json");
