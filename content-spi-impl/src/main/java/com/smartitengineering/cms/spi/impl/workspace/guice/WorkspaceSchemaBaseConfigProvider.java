 ...
 */
@Singleton
public class WorkspaceSchemaBaseConfigProvider implements
    Provider<SchemaInfoProviderBaseConfig<PersistentWorkspace>> {

  @Override
  public SchemaInfoProviderBaseConfig<PersistentWorkspace> get() {
    try {
      final InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream(
          "com/smartitengineering/cms/spi/impl/workspace/WorkspaceSchemaBaseConfig.json");
