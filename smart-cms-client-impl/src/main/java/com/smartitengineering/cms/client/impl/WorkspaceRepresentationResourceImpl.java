 ...
 * @author imyousuf
 */
public class WorkspaceRepresentationResourceImpl extends AbstractClientResource<ResourceTemplate, Resource> implements
    WorkspaceRepresentationResource {

  public WorkspaceRepresentationResourceImpl(Resource referrer, URI uri) {
    super(referrer, uri, MediaType.APPLICATION_JSON, ResourceTemplate.class);
  }

  public WorkspaceRepresentationResourceImpl(Resource referrer, ResourceLink link) {
    super(referrer, link);
  }
