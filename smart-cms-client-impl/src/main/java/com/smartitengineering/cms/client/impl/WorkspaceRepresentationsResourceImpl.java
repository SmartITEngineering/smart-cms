 ...
 * @author imyousuf
 */
public class WorkspaceRepresentationsResourceImpl extends AbstractFeedClientResource<WorkspaceRepresentationsResource>
    implements WorkspaceRepresentationsResource {

  public WorkspaceRepresentationsResourceImpl(Resource referrer, ResourceLink link) {
    super(referrer, link);
  }
  ...
  public Collection<WorkspaceRepresentationResource> getRepresentationsResources() {
    ...
    List<WorkspaceRepresentationResource> resources = new ArrayList<WorkspaceRepresentationResource>(entries.size());
    for (Entry entry : entries) {
      resources.add(new WorkspaceRepresentationResourceImpl(this, AtomClientUtil.convertFromAtomLinkToResourceLink(entry.
          getAlternateLink())));
    }
  ...
  public WorkspaceRepresentationResource createRepresentations(ResourceTemplate resourceTemplate) {
    ...
    return new WorkspaceRepresentationResourceImpl(this, response.getLocation());
  }
}
