 ...
 * @author imyousuf
 */
public class WorkspaceValidatorResourceImpl extends AbstractClientResource<ResourceTemplate, Resource> implements
    WorkspaceValidatorResource {

  public WorkspaceValidatorResourceImpl(Resource referrer, URI uri) {
    super(referrer, uri, MediaType.APPLICATION_JSON, ResourceTemplate.class);
  }

  public WorkspaceValidatorResourceImpl(Resource referrer, ResourceLink link) {
    super(referrer, link);
  }
