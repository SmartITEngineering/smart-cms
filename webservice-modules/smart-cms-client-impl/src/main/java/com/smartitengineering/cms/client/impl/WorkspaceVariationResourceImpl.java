 ...
 * @author kaisar
 */
public class WorkspaceVariationResourceImpl extends AbstractClientResource<ResourceTemplate, Resource> implements
    WorkspaceVariationResource {

  public WorkspaceVariationResourceImpl(Resource referrer, URI uri) {
    super(referrer, uri, MediaType.APPLICATION_JSON, ResourceTemplate.class);
  }

  public WorkspaceVariationResourceImpl(Resource referrer, ResourceLink link) {
    super(referrer, link);
  }
