...
public class WorkspaceRepresentationsResource extends AbstractResource {
  ...
  public WorkspaceRepresentationsResource(Workspace workspace, int count, ServerResourceInjectables injectables) {
    super(injectables);
  ...
  public Response postRepresentationsForm(@FormDataParam("name") String name,
