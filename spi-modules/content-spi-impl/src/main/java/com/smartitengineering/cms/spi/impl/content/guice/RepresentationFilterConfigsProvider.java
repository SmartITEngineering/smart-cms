 ...
 */
@Singleton
public class RepresentationFilterConfigsProvider implements Provider<FilterConfigs<PersistentRepresentation>> {

  @Override
  public FilterConfigs<PersistentRepresentation> get() {
    try {
      return JsonConfigLoader.parseJsonAsFilterConfigMap(getClass().getClassLoader().
          getResourceAsStream("com/smartitengineering/cms/spi/impl/content/RepresentationFilterConfigs.json"));
    }
