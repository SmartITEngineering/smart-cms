 ...
 * @author imyousuf
 */
public class JavascriptContentCoProcessorGenerator implements ContentCoProcessorGenerator {

  public ContentCoProcessor getGenerator(ContentCoProcessorTemplate template) throws InvalidTemplateException {
    return JavascriptObjectFactory.getInstance().getObjectFromScript(template.getTemplate(), ContentCoProcessor.class);
  }
}
