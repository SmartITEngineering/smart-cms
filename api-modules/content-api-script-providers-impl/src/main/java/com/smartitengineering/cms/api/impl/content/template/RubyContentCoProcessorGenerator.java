 ...
 * @author imyousuf
 */
public class RubyContentCoProcessorGenerator implements ContentCoProcessorGenerator {

  public ContentCoProcessor getGenerator(ContentCoProcessorTemplate template) throws InvalidTemplateException {
    return JRubyObjectFactory.getInstance().getObjectFromScript(template.getTemplate(), ContentCoProcessor.class);
  }
}
