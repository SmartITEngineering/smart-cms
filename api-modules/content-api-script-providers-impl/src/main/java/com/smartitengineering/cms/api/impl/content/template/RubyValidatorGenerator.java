 ...
 * @author imyousuf
 */
public class RubyValidatorGenerator extends AbstractTypeFieldValidator {

  @Override
  public FieldValidator getValidator(ValidatorTemplate template) throws InvalidTemplateException {
    return JRubyObjectFactory.getInstance().getObjectFromScript(template.getTemplate(), FieldValidator.class);
  }
}
