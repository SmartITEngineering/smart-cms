 ...
 * @author imyousuf
 */
public class GroovyContentCoProcessorGenerator implements ContentCoProcessorGenerator {

  public ContentCoProcessor getGenerator(ContentCoProcessorTemplate template) throws InvalidTemplateException {
    return GroovyObjectFactory.getInstance().getObjectFromScript(template.getTemplate(), ContentCoProcessor.class);
  }
}
